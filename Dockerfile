...
CMD ["sh", "-c", "rm -f /tmp/.X99-lock && npx prisma migrate deploy --config=/app/prisma.config.ts && xvfb-run --server-num=99 --server-args='-screen 0 1920x1080x24' node server.js"]